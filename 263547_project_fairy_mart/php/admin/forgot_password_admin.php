...
<head>
   ...
   <body>
        ...
        <div class="navbar">
            <a href="/263547_project_fairy_mart/php/admin/login_admin.php" class="right">Back to Log In <i class="fa fa-sign-in"></i></a>
        </div>

        <div class="main">
            <h2>Admin Forgot Password</h2>
            <div class="container">
                <form name="forgotPasswordForm" action="/263547_project_fairy_mart/php/admin/forgot_password_admin.php" onsubmit="return validateForgotPasswordForm()" method="post">
      ...
      if(mysqli_query($conn,"UPDATE tbl_admin SET password='$password' WHERE email='$email'")){
        ...
        <?php
         ...
         header("refresh:1; url=/263547_project_fairy_mart/php/admin/login_admin.php");
         ?>
