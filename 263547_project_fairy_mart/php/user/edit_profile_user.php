...
<html>
   ...
   <body>
        ...
        ?>
            ...
            <form name="editUserProfile" action="/263547_project_fairy_mart/php/user/edit_profile_user.php" onsubmit="return validateRegForm()" method="post">
            	<div class="row">
                	<div class="col-25">
                    	&nbsp<i class="fa fa-user icon"></i>&nbsp
...
?>
        <script type="text/javascript">alert("Update Successful");window.location = "main_page.php";</script>
<?php
   }              
?>