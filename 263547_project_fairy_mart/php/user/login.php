...
<body onload="loadCookies()">
	...
	<div class="navbar">
		<a href="/263547_project_fairy_mart/html/register.html" class="right">Register User <i class="fa fa-user-plus"></i></a>
		<a href="/263547_project_fairy_mart/index.html" class="right">Home <i class="fa fa-home"></i></a>
	</div>

	<div class="main">
		<h2>Log In User Account</h2>
		<div class="container">
			<form name="loginForm" action="/263547_project_fairy_mart/php/user/login.php" onsubmit="return validateLoginForm()" method="post">
				<div class="row">
					<div class="col-25">
				...
				<div class="forgot">
					<div class="forgotPassword">
						<a style="text-decoration:none; color: BlueViolet; font-weight: bold; text-align: center;" href="/263547_project_fairy_mart/php/user/forgot_password.php">Forgot Password ?</a>
					</div>
				</div>
			</form>
		</div>
